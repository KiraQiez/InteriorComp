...
<%@ page import="java.sql.Date, java.util.concurrent.TimeUnit" %>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="base"> 
            <div class="base-white"> 
                <div> 
                    <img src="resource/2.png" alt="Room Image"> 
                </div> 
                <div> 
                    <table> 
                        <tr> 
                            <td class="bookingID" colspan="2"> 
                                <p>BOOKING ID: 
                                    <sql:query var="RESULT" dataSource="${myDatasource}"> 
                                        SELECT R.ROOMNUMBER, R.ROOMPRICE, B.BOOKINGID, B.BOOKINGDATE, B.CHECKIN, B.CHECKOUT 
                                        FROM BOOKING B 
