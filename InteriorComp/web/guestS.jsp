    ...
    <div class="container">
        <nav class="navbar">
            ...
            <ul>
                ...
                <li><a href="guestS.jsp" class="active"><i class="fas fa-user"></i> <span>Guest</span></a></li>
            ...
            <div class="content">
                ...
                <div class="navigation-card" onclick="window.location.href='reportList.jsp';">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-description">Access detailed reports that have been reported by the guest.</div>
