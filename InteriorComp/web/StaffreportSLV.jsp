                    ...
                    <%@ include file="StaffHeader.jsp" %>
                        ...
                        <head>
                            <% HttpSession currentSession=request.getSession(false); if (currentSession==null ||
                                currentSession.getAttribute("loggedIn")==null || !(Boolean)
                                currentSession.getAttribute("loggedIn")) { response.sendRedirect("login.jsp"); return; }
                                String username=(String) currentSession.getAttribute("username"); String rank=(String)
                                currentSession.getAttribute("rank"); if(rank.equals("Guest")) {
                                response.sendRedirect("home.jsp"); return; } String
                        ...
                        <body>
                            <div class="container">
                                <nav class="navbar">
                                    ...
                                    <ul>
                                        <li><a href="Staffdashboard.jsp"><i class="fas fa-tachometer-alt"></i>
                                                <span>Dashboard</span></a></li>
                                        <li><a href="StaffroomS.jsp"><i class="fas fa-bed"></i> <span>Room</span></a>
                                        </li>
                                        <li><a href="StaffbookingS.jsp"><i class="fas fa-calendar-check"></i>
                                                <span>Booking</span></a></li>
                                        <li><a href="StaffguestS.jsp" class="active"><i class="fas fa-user"></i>
                                                <span>Guest</span></a></li>
                                        <li><a href="StaffstaffS.jsp"><i class="fas fa-users"></i>
                                ...
                                <div class="main-content">
                                    ...
                                    <div class="breadcrumb">
                                        <a href="StaffreportSL.jsp">Report</a> / <a href="#" class="active">Report
                                            Details</a>
                                    </div>
                                    ...
                                    <div class="content">
                                        <div class="details-container">
                                            ...
                                            <sql:query var="reportDetails" dataSource="${myDatasource}">
                                                SELECT r.*, s.stdName, hs.staffName AS handledByStaffName, cs.staffName
                                                AS checkedByStaffName
                                                FROM REPORT r
                                            ...
                                            <c:forEach var="report" items="${reportDetails.rows}">
                                                ...
                                                <div class="details-group">
                                                    ...
                                                    <p id="studentID">
                                                        <c:out value="${report.studentID}" />
                                                    </p>
                                                </div>
                                                <div class="details-group">
                                                    <label for="studentName">Student Name:</label>
                                                    <p id="studentName">
                                                        <c:out value="${report.stdName}" />
                                                    </p>
                                                </div>
                                                <div class="details-group">
                                                    <label for="handledByStaffID">Handled By:</label>
                                                    <p id="handledByStaffID">
                                                        <c:out value="${report.handledByStaffName}" />
                                                    </p>
                                                </div>
                                                <div class="details-group">
                                                    <label for="checkedByStaffID">Checked By:</label>
                                                    <p id="checkedByStaffID">
                                                        <c:out value="${report.checkedByStaffName}" />
                                                    </p>
                                                </div>
                                            </c:forEach>
                                        </div>
