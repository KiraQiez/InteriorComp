...
<p class="title">ROOM DETAILS</p>
    <div class="base">
        <div class="room">
            ...
            <p>Room ID: <c:out value="${param.roomID}"/></p>
        </div>

        <sql:query var="RESULT" dataSource="${myDatasource}">
            SELECT BOOKINGID, STUDENTID FROM BOOKING WHERE ROOMID = ?
        ...
        <div class="student">
            <c:forEach var="row" items="${RESULT.rows}">
                <div class="base-white">
                    <div>
                        <img src="resource/ProfilePicture.png" alt="Profile Picture">
                    </div>
                    <div>
                        <table>
                            <tr>
                                <td colspan="2">
                                    <p>BOOKING ID: <c:out value="${row.BOOKINGID}"/></p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <p>STUDENT ID: <c:out value="${row.STUDENTID}"/></p>
                                </td>
                            </tr>
                        </table>
                    </div>
